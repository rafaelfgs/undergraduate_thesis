%% Pré aloca as variáveis de posição, de velocidade e do tempo
...
% Posições e orientações iniciais dos Robôs e da Bola
Postura.Robo1 = [999;999;0];
Postura.Robo2 = [999;999;0];
Postura.Robo3 = [999;999;0];
Postura.Adv1  = [999;999;0];
Postura.Adv2  = [999;999;0];
Postura.Adv3  = [999;999;0];
Postura.Bola  = [999;999;0];

% Velocidades Lineares e Angulares iniciais dos Robôs e da Bola
Velocidade.Robo1 = [0;0;0];
Velocidade.Robo2 = [0;0;0];
Velocidade.Robo3 = [0;0;0];
Velocidade.Adv1  = [0;0;0];
Velocidade.Adv2  = [0;0;0];
Velocidade.Adv3  = [0;0;0];
Velocidade.Bola  = [0;0;0];

% Variáveis para analisar o tempo
Tempo.NRotinas = 12;
Tempo.Frames = zeros(Tempo.NRotinas,1);
Tempo.Tf = zeros(Tempo.NRotinas,1);

% Variancia do sistema de medição de velocidadee da variancia da estimacao da velocidade
% Representa o quanto o objeto pode alterar sua velocidade em um período de amostragem
Filtro.VARW = 1 * eye(3);
Filtro.VARN = 1 * eye(3);

% Erro medio quadratico inicial da velocidade em qualquer direção
