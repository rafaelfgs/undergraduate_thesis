...
for ii = [Constantes.CorNos Constantes.CorAdv Constantes.CorRobo Constantes.CorBola]
    ...
    if any(ii == [Constantes.CorNos Constantes.CorAdv Constantes.CorBola])
        Cores.AreasM(Cores.AreasM(:,ii) > Constantes.Area1Max | Cores.AreasM(:,ii) < Constantes.Area1Min ,ii) = 0;
    elseif any(ii == Constantes.CorRobo)
        Cores.AreasM(Cores.AreasM(:,ii) > Constantes.Area2Max | Cores.AreasM(:,ii) < Constantes.Area2Min ,ii) = 0;
    end
