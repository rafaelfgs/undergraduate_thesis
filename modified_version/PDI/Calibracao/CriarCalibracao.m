...
set(TelaCalibracao.Fig,'menubar','none','numbertitle','off','name','Calibração das Cores','closerequestfcn','FecharCalibracao')
...
TelaCalibracao.Botao.Slider(1) = uicontrol(TelaCalibracao.Fig,'style','slider','Min',0,'Max',360,'value',0,  'sliderstep',[1/180 1/18],'units','normalized','position',[0.12 0.875 0.19 0.05],'backgroundcolor',hsv2rgb([0 0 0.8]),'callback','AtualizarSlider');
TelaCalibracao.Botao.Slider(2) = uicontrol(TelaCalibracao.Fig,'style','slider','Min',0,'Max',360,'value',360,'sliderstep',[1/180 1/18],'units','normalized','position',[0.12 0.825 0.19 0.05],'backgroundcolor',hsv2rgb([0 0 0.6]),'callback','AtualizarSlider');
